...
namespace DocProAPI.Customs.Queue
{
    public class FCMPushNotification
    {
        ...
        public FCMPushNotification SendNotification(string _title, string _message, string _topic, string YOUR_FCM_SERVER_API_KEY= "AIzaSyCyzCLh_wsJfMeJykX2h9-9SQiGQdrc11o", string YOUR_FCM_SENDER_ID= "docpromobile-41.374",string YOUR_FCM_DEVICE_ID="")
        {
